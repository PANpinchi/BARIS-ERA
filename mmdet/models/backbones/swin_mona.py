...
class SwinBlock(BaseModule):
    ...
    def __init__(self,
        ...
        self.my_module_1 = Mona(embed_dims, 8)
        self.my_module_2 = Mona(embed_dims, 8)  # Adapter_FFN(dim, 8)
    ...
    def forward(self, x, hw_shape):
        ...
        def _inner_forward(x):
            ...
            x = self.my_module_2(x, hw_shape)  # todo: correct
...
class SwinTransformerWithMona(BaseModule):
    """ Swin Transformer with Mona
    ...
    def __init__(self,
        ...
        super(SwinTransformerWithMona, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        """Convert the model into training mode while keep layers freezed."""
        super(SwinTransformerWithMona, self).train(mode)
        self._freeze_stages()
