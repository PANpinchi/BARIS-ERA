...
class SwinTransformerWithLoRA(BaseModule):
    """ Swin Transformer with LoRA
    ...
    def __init__(self,
        ...
        super(SwinTransformerWithLoRA, self).__init__(init_cfg=init_cfg)
    ...
    def train(self, mode=True):
        ...
        super(SwinTransformerWithLoRA, self).train(mode)
        self._freeze_stages()
