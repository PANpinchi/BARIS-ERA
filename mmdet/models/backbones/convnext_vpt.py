...
from ..tuning_modules import PadPrompter
...
class ConvNeXtWithVPT(BaseModule):
    """ConvNeXt v1&v2 backbone with visual prompt tuning (VPT).
    ...
    def __init__(self,
        ...
        self.tuning_module = PadPrompter(prompt_size=10, image_size=1344)
    ...
    def train(self, mode=True):
        super(ConvNeXtWithVPT, self).train(mode)
        self._freeze_stages()
